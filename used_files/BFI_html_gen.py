...
def likert_header():
    ...
    """
    headings = ["Disagree strongly", "", "Neither agree nor disagree", "", "Agree strongly"]
...
end_new = "\n\t\t\t<div style='text-align: center;'><input type='submit' name='BFSUBMIT' value='Submit'/></div>\n\t\t\t</form>\n\t\t<empty></empty>\t</middle_wrapper>\n\t<empty></empty>\n</maincontainer>"


with open("BF.html", 'w+') as wf:
